      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            <Badge className="bg-green-600 text-white">Nutrition</Badge>
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4 leading-tight">
            Nutrient Schedules & Feeding: Feeding Your Cannabis Right
          </h1>

          <p className="text-xl text-sage-300 mb-6 leading-relaxed">
            Master nutrient schedules to optimize cannabis growth and yield. Learn the role of macronutrients,
            micronutrients, and feeding techniques for healthy plants.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-6 mb-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-white font-semibold">Dr. Lisa Patel</div>
                <div className="text-sage-400 text-sm">Plant Nutritionist</div>
              </div>
            </div>
            ...
            <div className="text-sage-400 text-sm">Published: April 5, 2025</div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Button variant="outline" className="border-sage-600 text-sage-300 hover:bg-sage-800">
              <Bookmark className="h-4 w-2 mr-2" />
              Save
            </Button>
            <Button variant="outline" className="border-sage-600 text-sage-300 hover:bg-sage-800">
        ...
        <div className="relative h-64 md:h-96 rounded-lg overflow-hidden mb-8">
          <Image src="/placeholder.svg?height=400&width=800" alt="Nutrient Feeding" fill className="object-cover" />
