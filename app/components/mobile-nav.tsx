...
export function MobileNav({ mobileMenuOpen, setMobileMenuOpen, cartItemCount = 0, currentPath }: MobileNavProps) {
  return (
    <>
      ...
      {/* Mobile Navigation */}
      <div 
        className={`fixed inset-x-0 top-[73px] md:hidden transition-all duration-300 ease-in-out ${
          mobileMenuOpen 
            ? "max-h-[calc(100vh-73px)] opacity-100 border-t border-sage-800 bg-black/95 backdrop-blur-sm overflow-y-auto" 
